                ...
                case 'm':
                  {
                    ...
                    BOOST_CATCH(std::out_of_range&) { // base class for bad_month exception
                      if(this->m_sv_parser.match(sitr, stream_end, mr)) {
                        t = time_type(static_cast<special_values>(mr.current_match));
                        return sitr;
                      }
                      else {
                        BOOST_RETHROW; // rethrow bad_month
                      }
                    }
					BOOST_CATCH_END
                ...
                case 'w':
                  {
                    ...
                    BOOST_CATCH(std::out_of_range&) { // base class for bad_weekday exception
                      if(this->m_sv_parser.match(sitr, stream_end, mr)) {
                        t = time_type(static_cast<special_values>(mr.current_match));
                        return sitr;
                      }
                ...
                case 'd':
                  {
                    ...
                    BOOST_CATCH(std::out_of_range&) { // base class for exception bad_day_of_month
                      match_results mr;
                      if(this->m_sv_parser.match(sitr, stream_end, mr)) {
                        t = time_type(static_cast<special_values>(mr.current_match));
                        return sitr;
                        ...
                        BOOST_RETHROW; // rethrow bad_day_of_month
                      }
                    }
					BOOST_CATCH_END
                    break;
