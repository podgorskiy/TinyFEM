...
#include <boost/detail/no_exceptions_support.hpp> // for BOOST_TRY
...
class progress_timer : public timer::cpu_timer, private noncopyable
{
  
 public:
  explicit progress_timer( std::ostream & os = std::cout )
     // os is hint; implementation may ignore, particularly in embedded systems
     : timer::cpu_timer(), noncopyable(), m_os(os) {}
  ~progress_timer()
  {
  ...
  //  Therefore, wrap the I/O in a try block, catch and ignore all exceptions.
    ...
    BOOST_CATCH (...) {} // eat any exceptions
	BOOST_CATCH_END
  } // ~progress_timer
